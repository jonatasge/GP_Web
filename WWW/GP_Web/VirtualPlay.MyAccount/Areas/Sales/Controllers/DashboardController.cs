    ...
    public class DashboardController : Controller
    {
        ...
        public JsonResult SalesData(int? year, int? month, int? day)
        {
            ...
            if (UserManager.User != null)
            {
                ...
                var result = apiDashboard.Sale(UserManager.User.idMerchant, year.Value, month.Value, day.Value);
        ...
        public JsonResult SalesDataRefund(int? year, int? month, int? day)
        {
            ...
            if (UserManager.User != null)
            {
                ...
                var result = apiDashboard.Refund(UserManager.User.idMerchant, year.Value, month.Value, day.Value);
        ...
        public JsonResult SalesDataInstallment(int? year, int? month, int? day)
        {
            ...
            if (UserManager.User != null)
            {
                ...
                var result = apiDashboard.Installment(UserManager.User.idMerchant, year.Value, month.Value, day.Value);
        ...
        public JsonResult SalesDataCardBrand(int? year, int? month, int? day)
        {
            ...
            if (UserManager.User != null)
            {
                ...
                var result = apiDashboard.CardBrand(UserManager.User.idMerchant, year.Value, month.Value, day.Value);
