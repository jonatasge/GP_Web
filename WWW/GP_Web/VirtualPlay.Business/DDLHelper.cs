...
namespace VirtualPlay.Business
{
    public static class DDLHelper
    {
        ...
        public static IList<SelectListItem> GetStatusDefault()
        {
            IList<SelectListItem> _result = new List<SelectListItem>();

            _result.Add(new SelectListItem { Value = "A", Text = "Ativo", Selected = false });
            _result.Add(new SelectListItem { Value = "I", Text = "Inativo", Selected = false });

            return _result;
        }

        public static IList<SelectListItem> GetRateType()
        {
            IList<SelectListItem> _result = new List<SelectListItem>();

            _result.Add(new SelectListItem { Value = "M", Text = "Loja/Vendedor", Selected = false });
            _result.Add(new SelectListItem { Value = "A", Text = "Adquirente", Selected = false });

            return _result;
        }

        public static IList<SelectListItem> GetYesNo()
        {
            IList<SelectListItem> _result = new List<SelectListItem>();

            _result.Add(new SelectListItem { Value = "S", Text = "Sim", Selected = false });
            _result.Add(new SelectListItem { Value = "N", Text = "Não", Selected = false });

            return _result;
        }

        public static IList<SelectListItem> GetDays(int days)
        {
            IList<SelectListItem> _result = new List<SelectListItem>();
