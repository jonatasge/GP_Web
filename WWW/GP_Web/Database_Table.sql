...
CREATE TABLE [VirtualPlay].[Sys_System](
	...
	[dsSystem] [varchar](500) COLLATE SQL_Latin1_General_CP1_CI_AI NOT NULL,
...
CREATE TABLE [VirtualPlay].[Sys_WebmailConf](
	[idWebmail] [int] NOT NULL IDENTITY(1,1),
	[idSequence] INT NOT NULL,
	[dsFrom] [nvarchar](120) NOT NULL,
	[dsHost] [nvarchar](120) NOT NULL,
	[nbPort] [int] NOT NULL,
	[cdUserName] [nvarchar](120) NOT NULL,
	[cdPassword] [nvarchar](120) NOT NULL,
	[flEnableSsl] [bit] NULL,
	[flUseDefaultCredentials] [bit] NULL,
	[dtCreatedAt] [datetime] NOT NULL,
	[dtUpdatedAt] [datetime] NULL,
	[flStatus] [bit] NOT NULL,
	CONSTRAINT [PK_VP_Sys_WebmailConf] PRIMARY KEY CLUSTERED 
(
	[idWebmail] ASC,
	[idSequence] ASC
)WITH FILLFACTOR = 75 ON [PRIMARY]
...
CREATE TABLE [VirtualPlay].[Sys_WebmailLog](
	[id] [int] NOT NULL  IDENTITY(1,1),
	[idWebmail] [int] NOT NULL,
	[idSequence] INT NOT NULL,
	[dsMailTo] VARCHAR(500) NULL,
	[dsError] VARCHAR(4500) NULL,
	[dsSubject] VARCHAR(500) NULL,
	[dsMessage] VARCHAR(4500) NULL,
	[dsExtra] VARCHAR(4500) NULL,
	[cdIdentification1] VARCHAR(100) NULL,
	[cdIdentification2] VARCHAR(100) NULL,
	[cdIdentification3] VARCHAR(100) NULL,
	[idSystem] [int] NULL,
...
ALTER TABLE [VirtualPlay].[Sys_WebmailLog] 
ADD CONSTRAINT FK_VP_Sys_WebmailLog_Conf
FOREIGN KEY (idWebmail, idSequence) REFERENCES [VirtualPlay].[Sys_WebmailConf](idWebmail, idSequence);

GO

ALTER TABLE [VirtualPlay].[Sys_WebmailLog] 
ADD CONSTRAINT FK_VP_Sys_WebmailLog_System
FOREIGN KEY (idSystem) REFERENCES [VirtualPlay].[Sys_System](idSystem);

GO

ALTER TABLE [VirtualPlay].[Sys_WebmailLog] 
ADD CONSTRAINT FK_VP_Sys_WebmailLog_User
FOREIGN KEY (idUserCreate) REFERENCES [VirtualPlay].[Sys_User](idUser);